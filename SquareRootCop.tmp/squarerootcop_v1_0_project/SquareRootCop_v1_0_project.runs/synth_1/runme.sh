...
HD_PWD='c:/users/pedro/dropbox/ua/cr/project/cr-project/squarerootcop.tmp/squarerootcop_v1_0_project/SquareRootCop_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareRootCop_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SquareRootCop_v1_0.tcl
