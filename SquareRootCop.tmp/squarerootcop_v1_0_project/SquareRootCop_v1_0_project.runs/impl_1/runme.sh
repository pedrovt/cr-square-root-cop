...
HD_PWD='c:/users/pedro/dropbox/ua/cr/project/cr-project/squarerootcop.tmp/squarerootcop_v1_0_project/SquareRootCop_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareRootCop_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SquareRootCop_v1_0.tcl -notrace
