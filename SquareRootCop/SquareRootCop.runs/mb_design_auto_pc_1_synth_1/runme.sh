...
HD_PWD='C:/Users/Pedro/Dropbox/UA/CR/Project/CR-Project/SquareRootCop/SquareRootCop.runs/mb_design_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_auto_pc_1.tcl
