...
end SquareRootCop_v1_0;

architecture arch_imp of SquareRootCop_v1_0 is

	-- component declaration
	component SquareRootCop_v1_0_S00_AXIS is
		generic (
	...
	end component SquareRootCop_v1_0_S00_AXIS;

	component SquareRootCop_v1_0_M00_AXIS is
		generic (
        ...
        remainer        : in std_logic_vector(C_M_AXIS_TDATA_WIDTH-1 downto 0);
        byteEnable      : in std_logic_vector((C_M_AXIS_TDATA_WIDTH/8)-1 downto 0);
        lastWord        : in std_logic;
        readEnabled     : out std_logic		
		-- User ports ends
		);
	end component SquareRootCop_v1_0_M00_AXIS;

	component SquareRootCop_v1_0_M01_AXIS is
		generic (
		C_M_AXIS_TDATA_WIDTH	: integer	:= 32;
		C_M_START_COUNT	: integer	:= 32
		);
		...
		-- Users to add ports here
		dataValid       : in std_logic;
        sqrt            : in std_logic_vector(C_M_AXIS_TDATA_WIDTH-1 downto 0);
        byteEnable      : in std_logic_vector((C_M_AXIS_TDATA_WIDTH/8)-1 downto 0);
        lastWord        : in std_logic;
        readEnabled     : out std_logic		
        -- User ports ends
		);
	end component SquareRootCop_v1_0_M01_AXIS;
	
	-- Users to add signals here
	signal s_dataValid    : std_logic;
    signal s_sqrt         : std_logic_vector(C_M00_AXIS_TDATA_WIDTH-1 downto 0);
    signal s_remainer     : std_logic_vector(C_M00_AXIS_TDATA_WIDTH-1 downto 0);
    ...
    signal s_readEnabled0 : std_logic;
    signal s_readEnabled1 : std_logic;
    -- User signals ends

begin

-- Instantiation of Axi Bus Interface S00_AXIS
SquareRootCop_v1_0_S00_AXIS_inst : SquareRootCop_v1_0_S00_AXIS
	generic map (
...
SquareRootCop_v1_0_M00_AXIS_inst : SquareRootCop_v1_0_M00_AXIS
	generic map (
	...
	port map (
        ...
        byteEnable      => s_byteEnable,
        lastWord        => s_lastWord,
        readEnabled     => s_readEnabled0
	);

-- Instantiation of Axi Bus Interface M01_AXIS
SquareRootCop_v1_0_M01_AXIS_inst : SquareRootCop_v1_0_M01_AXIS
	generic map (
	...
	port map (
        ...
        byteEnable      => s_byteEnable,
        lastWord        => s_lastWord,
        readEnabled     => s_readEnabled1
	);

	-- Add user logic here
    s_readEnabled <= s_readEnabled0 and s_readEnabled1;
	-- User logic ends
